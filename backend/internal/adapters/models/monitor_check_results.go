...
type MonitorCheckResult struct {
	...
	ResponseTime   int    `boil:"response_time" json:"response_time" toml:"response_time" yaml:"response_time"`
...
var MonitorCheckResultTableColumns = struct {
	...
	ResponseStatus: "monitor_check_results.response_status",
	ResponseTime:   "monitor_check_results.response_time",
}
...
var MonitorCheckResultWhere = struct {
	...
	ResponseTime   whereHelperint
}{
	ID:             whereHelperstring{field: "\"monitor_check_results\".\"id\""},
	MonitorID:      whereHelperstring{field: "\"monitor_check_results\".\"monitor_id\""},
	ResponseStatus: whereHelperint{field: "\"monitor_check_results\".\"response_status\""},
	ResponseTime:   whereHelperint{field: "\"monitor_check_results\".\"response_time\""},
}
...
var (
	monitorCheckResultAllColumns            = []string{"id", "monitor_id", "response_status", "response_time"}
	monitorCheckResultColumnsWithoutDefault = []string{"id", "monitor_id", "response_status", "response_time"}
	monitorCheckResultColumnsWithDefault    = []string{}
