...
type User struct {
	...
	PrimaryPhoneNumber   string      `boil:"primary_phone_number" json:"primary_phone_number" toml:"primary_phone_number" yaml:"primary_phone_number"`
	SecondaryPhoneNumber string      `boil:"secondary_phone_number" json:"secondary_phone_number" toml:"secondary_phone_number" yaml:"secondary_phone_number"`
	...
	OnHolidaysUntil      null.Time   `boil:"on_holidays_until" json:"on_holidays_until,omitempty" toml:"on_holidays_until" yaml:"on_holidays_until,omitempty"`
...
var UserColumns = struct {
	...
	Timezone:             "timezone",
	OnHolidaysUntil:      "on_holidays_until",
...
var UserTableColumns = struct {
	...
	Email:                "users.email",
	PrimaryPhoneNumber:   "users.primary_phone_number",
	SecondaryPhoneNumber: "users.secondary_phone_number",
	AvatarURL:            "users.avatar_url",
	Timezone:             "users.timezone",
	OnHolidaysUntil:      "users.on_holidays_until",
...
var UserWhere = struct {
	...
	PrimaryPhoneNumber   whereHelperstring
	SecondaryPhoneNumber whereHelperstring
	AvatarURL            whereHelpernull_String
	Timezone             whereHelpernull_String
	OnHolidaysUntil      whereHelpernull_Time
	...
	PrimaryPhoneNumber:   whereHelperstring{field: "\"users\".\"primary_phone_number\""},
	SecondaryPhoneNumber: whereHelperstring{field: "\"users\".\"secondary_phone_number\""},
	AvatarURL:            whereHelpernull_String{field: "\"users\".\"avatar_url\""},
	Timezone:             whereHelpernull_String{field: "\"users\".\"timezone\""},
	OnHolidaysUntil:      whereHelpernull_Time{field: "\"users\".\"on_holidays_until\""},
	ConfirmationCode:     whereHelpernull_String{field: "\"users\".\"confirmation_code\""},
...
func (r *userR) GetTeams() TeamSlice {
	if r == nil {
		return nil
	}
	return r.Teams
...
var (
	userAllColumns            = []string{"id", "account_id", "first_name", "last_name", "email", "primary_phone_number", "secondary_phone_number", "avatar_url", "timezone", "on_holidays_until", "confirmation_code", "created_at"}
	userColumnsWithoutDefault = []string{"id", "account_id", "first_name", "last_name", "email", "primary_phone_number", "secondary_phone_number"}
	userColumnsWithDefault    = []string{"avatar_url", "timezone", "on_holidays_until", "confirmation_code", "created_at"}
...
func (o *User) Teams(mods ...qm.QueryMod) teamQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"team_members\" on \"teams\".\"id\" = \"team_members\".\"team_id\""),
		qm.Where("\"team_members\".\"member_id\"=?", o.ID),
	)
...
func (userL) LoadTeams(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.Select("\"teams\".\"id\", \"teams\".\"account_id\", \"teams\".\"name\", \"a\".\"member_id\""),
		qm.From("\"teams\""),
		qm.InnerJoin("\"team_members\" as \"a\" on \"teams\".\"id\" = \"a\".\"team_id\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.AccountID, &one.Name, &localJoinCol)
		if err != nil {
			return errors.Wrap(err, "failed to scan eager loaded results for teams")
		}
		if err = results.Err(); err != nil {
			return errors.Wrap(err, "failed to plebian-bind eager loaded slice teams")
		}
	...
	if singular {
		...
		for _, foreign := range resultSlice {
			...
			foreign.R.MemberUsers = append(foreign.R.MemberUsers, object)
		}
		return nil
	}
	...
	for i, foreign := range resultSlice {
		...
		for _, local := range slice {
			if local.ID == localJoinCol {
				...
				foreign.R.MemberUsers = append(foreign.R.MemberUsers, local)
				break
			}
		}
	}
...
// Sets related.R.MemberUsers appropriately.
func (o *User) AddTeams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Team) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"team_members\" (\"member_id\", \"team_id\") values ($1, $2)"
	...
	for _, rel := range related {
		if rel.R == nil {
			rel.R = &teamR{
				MemberUsers: UserSlice{o},
			}
		} else {
			rel.R.MemberUsers = append(rel.R.MemberUsers, o)
		}
	}
	return nil
}
...
// Sets o.R.MemberUsers's Teams accordingly.
// Replaces o.R.Teams with related.
// Sets related.R.MemberUsers's Teams accordingly.
func (o *User) SetTeams(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Team) error {
	...
	removeTeamsFromMemberUsersSlice(o, related)
	if o.R != nil {
		o.R.Teams = nil
	}
...
// Sets related.R.MemberUsers.
func (o *User) RemoveTeams(ctx context.Context, exec boil.ContextExecutor, related ...*Team) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"team_members\" where \"member_id\" = $1 and \"team_id\" in (%s)",
...
func removeTeamsFromMemberUsersSlice(o *User, related []*Team) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
		for i, ri := range rel.R.MemberUsers {
			if o.ID != ri.ID {
				continue
			}

			ln := len(rel.R.MemberUsers)
			if ln > 1 && i < ln-1 {
				rel.R.MemberUsers[i] = rel.R.MemberUsers[ln-1]
			}
			rel.R.MemberUsers = rel.R.MemberUsers[:ln-1]
			break
		}
	}
}
