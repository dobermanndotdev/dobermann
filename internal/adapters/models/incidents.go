...
var IncidentWhere = struct {
	...
	ResponseStatus: whereHelpernull_Int16{field: "\"incidents\".\"response_status\""},
...
var (
	incidentAllColumns            = []string{"id", "monitor_id", "resolved_at", "cause", "response_status", "checked_url", "created_at"}
	incidentColumnsWithoutDefault = []string{"id", "monitor_id", "checked_url"}
	incidentColumnsWithDefault    = []string{"resolved_at", "cause", "response_status", "created_at"}
